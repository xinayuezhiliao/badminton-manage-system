...
public class db {
    ...
    // private String sConnStr = "jdbc:microsoft:sqlserver://localhost:1433;databasename=badminton";

    private String dbDriver="com.mysql.cj.jdbc.Driver";
    private String sConnStr = "jdbc:mysql://localhost:3306/badminton?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai";

    // private String dbDriver="net.sourceforge.jtds.jdbc.Driver";
    // private String sConnStr = "jdbc:jtds:sqlserver://127.0.0.1:1433;databaseName=badminton";
    ...
    public String hsggetoption2(String ntable,String nzd){
        StringBuffer imgStr = new StringBuffer();
        imgStr.append("");
        imgStr.append("<option value=''>hehe</option>\n");
    ...
    public List getShouyebht(){
        String sql = "select id,biaoti,shouyetupian from xinwentongzhi where leibie='绔欏唴鏂伴椈' order by id desc";
        list = new ArrayList();
        try{
            connect=DriverManager.getConnection(sConnStr,nsa,nmm);
            Statement stmt=connect.createStatement();
    ...
    public String getxwlb(){
        ...
        String sql="";
        sql="select distinct(leibie) as ss from xinwentongzhi where leibie<>'鍙樺够鍥?";
        System.out.print(sql);
        try{
            connect=DriverManager.getConnection(sConnStr,nsa,nmm);
            Statement stmt=connect.createStatement();
    ...
    public String getddnr(String nuser){
        ...
        String sql = "select shangpinmingcheng,goumaishuliang from goumaijilu where goumairen = '"+nuser+"' and issh='鍚? ";
        System.out.print(sql);
