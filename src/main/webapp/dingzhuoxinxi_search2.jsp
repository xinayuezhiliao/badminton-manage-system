...
<body>
    ...
    <div class="container">
        ...
        <div class="search-box">
            <form action="<%=basePath%>dingzhuoxinxi?action=doSearch2" method="post" class="search-form">
