...
<body>
    ...
    <div class="container">
        ...
        <div class="search-box">
            <form action="<%=basePath%>dingzhuoxinxi?action=doSearch" method="post" class="search-form">
                ...
                <div style="display: flex; gap: 15px; grid-column: 1 / -1;">
                    ...
                    <a href="<%=basePath%>dingzhuoxinxi?action=list" class="back-btn">返回列表</a>
                </div>
            </form>
        </div>
        ...
        <div class="result-box">
            <%
                List<Dingzhuoxinxi> recordList = (List<Dingzhuoxinxi>) request.getAttribute("dingzhuoxinxiList");
            ...
            %>
                ...
                <div class="result-info">
                    ...
                    <% } %>
                    &nbsp;&nbsp;|&nbsp;&nbsp; 
                    📊 共找到 <strong style="color: #16a085;"><%=recordList.size()%></strong> 条记录
                </div>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <% if (u.getId() != null) { %>
                                <a href="<%=basePath%>dingzhuoxinxi?action=toUpdate&id=<%=u.getId()%>" 
                                   class="action-btn edit-btn">编辑</a>
                                <a href="<%=basePath%>dingzhuoxinxi?action=delete&id=<%=u.getId()%>" 
            ...
            %>
                <div class="empty-state">
                    <div class="icon">😕</div>
                    <p>未找到符合条件的订场信息</p>
                    <p style="font-size: 15px; color: #7f8c8d;">请检查输入的场地号或会员编号是否正确，或尝试其他关键词</p>
                </div>
            <%
                }
            %>
